...
TARGET_PREBUILT_KERNEL := $(KERNEL_PATH)-kernel/kernel
TARGET_PREBUILT_DTB := $(KERNEL_PATH)-kernel/dtb.img
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB)
BOARD_INCLUDE_DTB_IN_BOOTIMG := 
BOARD_PREBUILT_DTBOIMAGE := $(KERNEL_PATH)-kernel/dtbo.img
BOARD_KERNEL_SEPARATED_DTBO := 
endif

# Kernel modules
BOARD_VENDOR_KERNEL_MODULES := $(wildcard $(KERNEL_PATH)-kernel/vendor-modules/*.ko)
...
# SPL
VENDOR_SECURITY_PATCH := 2024-09-25
